...
shinyUI(navbarPage("Boomer's Pool - Golf Major Tracking", position = 'fixed-top', collapsible = T,
# HEAD TAB 1 - WELCOME #########################################################
...
# sub tab 1 ====================================================================
                                tabPanel('Entry Players and Combination Counts',
                                    br(),
                                    fluidRow(column(6,
                                    absolutePanel(fixed = T, height = '100%', top = 100, bottom = 0,
                                    wellPanel(
                                    ...
                                    checkboxGroupInput('i_show_plyrs', 'Plyr Idx to Include',
                                                       c('Player 1',
                                                         'Player 2',
                                                         'Player 3',
                                                         'Player 4',
